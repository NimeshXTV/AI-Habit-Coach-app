...
public class ApiExceptionHandler {
    ...
    /** Every device-scoped route requires the X-Device-Id header (see
     * mobile's api.ts) — a request missing it (e.g. a stale client build)
     * gets a clear 400 instead of a confusing 500. */
